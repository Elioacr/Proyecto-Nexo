        ...
        <div class="row">
            <div class="col-md-12 mb-4">
                <div class="p-4 border rounded">
                    <h2>¿Quiénes somos?</h2>
                    <p>Somos NEXO, una página web que busca que las organizaciones con voluntariados tengan más visibilidad para las personas altruistas que buscan ayudar a comunidades que lo necesiten. Regístrate como voluntario y busca voluntariados cercanos a tu ubicación para ayudar a comunidades que lo necesiten.</p>
                </div>
            </div>
        </div>
